...
<ol>
    ...
    <li>
        ...
        <ul>
            <li>
                ...
                <p>Click on the gray FirePHP icon on the right side of the address bar. Then click the grant checkbox.</p>
    ...
    <li>
        ...
        <p>Open devtools (press F12), click on the FirePHP devtools tab and then click one of the <i>FirePHP (Wildfire based) Protocol</i> checkboxes.</p>
    ...
    <li>
        ...
        <p>You should see log messages generated by the PHP script that generated this page. See <i>Server Library Setup</i> below for how these messages were generated.</p>
...
<ol>
    ...
    <li>
        <p><b>Include FirePHPCore</b> on any page in your application to get started:</p>
...
<ol>
    <li><b>Disable FirePHPCore</b> using the <code>FB::setEnabled(false)</code> or <code>$firephp->setEnabled(false)</code> API calls. Using this approach you can leave all logging calls in place.</li>
